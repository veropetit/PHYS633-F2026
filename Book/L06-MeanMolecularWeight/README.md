...
***Micro-objectives:***
* 6.1: I can state the ideal gas law in terms of the concentration of free particles.
* 6.2: I can explain the concept of “free” particles in a plasma (gas with ionization)
* 6.3: I can use logic to relate the concentration of free particles with density, for simple cases
* 6.4: I can state the definition of the mean molecular weight
...
***Micro-objectives:***
* 6.5: I can state the mass fraction of Hydrogen and He of the sun.
* 6.6: I can sketch the mass fraction as a function of element for the sun.
* 6.7: I can explain the conceptual meaning of $\mu_\mathrm{ion}$ and $\mu_\mathrm{e}$ using explanatory examples.
* 6.8: I can derive the expressions for  $1/\mu_\mathrm{ion}$ and $1/\mu_\mathrm{e}$ as a function of the mass fraction. 
* 6.9: I can sketch the variation of the mean molecular weight as a function of radial coordinate for the current-day sun, and explain the different zones. 
