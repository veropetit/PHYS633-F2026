...
***Micro-objective:*** 
* 4.1: I can explain why we need to introduce an “equation of state” to be able to solve the structure of a star. 
* 4.2 I can explain why using the “ideal gas law” is not the final solution, and how using a “polytropic” equation of state can be used right now as an approximation. 
---
...
where $\theta$ is a unit-less function that describes the variation of the density as a function of radius. 
...
***Micro-objectives:***
* 4.3: I can identify all of the terms in the polytropic equation of state. 
* 4.4: I can explain the meaning of the terms in our solution 'shape'.
* 4.5: I can explain where the $\alpha$ constant we use to normalize the radial coordinate $r$ comes from. 
...
***Micro-objectives:*** 
* 4.6: In a graph of $\theta(\epsilon)$ versus $\epsilon$, I can identify the center and surface of a star. 
* 4.7: I can transform a graph of $\theta(\epsilon)$ versus $\epsilon$ into a graph of $\rho/\rho_o$ versus $r/R_\star$.
...
Micro-objectives:
* 4.8: I can explain how the expressions for $R_\star$, $P_o$, and $M_\star$ create a system of 3 equations and 5 unknowns. 
* 4.9: I can use polytropic models to compare with the Sun’s density profile shape and central density value. 
